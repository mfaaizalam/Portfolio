    ...
    <ul className="space-y-3 mt-0">
      {items.map(({ label, href }, i) => (
        <li key={i}>
          ...
          >
            <span className="text-gold/30 group-hover:text-gold transition-colors duration-200 text-[10px]">›</span>
            <span className="font-mono-gh text-[9px] tracking-[2px] text-cream/35 group-hover:text-cream/70 transition-colors duration-200">
              {label.toUpperCase()}
            </span>
          </motion.a>
        </li>
...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#0c0a07] border-t border-gold/10 overflow-hidden">
      ...
      {/* Subtle grid (same as About hero) */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <FadeIn delay={0} className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mb-5">
              <LogoMark size={26} />
              <span className="font-fraunces font-bold tracking-[3px] text-cream/80 text-[13px]">
                GOLDENHORDE
              </span>
            </div>

            {/* Tagline */}
            <p className="text-cream/35 font-light leading-[1.85] text-[13px] mb-7 max-w-[240px]">
            ...
            <div className="flex gap-2.5">
              {SOCIALS.map((s) => (
                <motion.a
                  ...
                  className="relative w-9 h-9 rounded-[2px] border flex items-center justify-center no-underline transition-colors duration-250"
                  style={{
          ...
          <FadeIn delay={0.1}>
            <div>
              <span className="font-mono-gh text-[8px] tracking-[3.5px] text-gold/55 block mb-5">
                SERVICES
              </span>
              {/* Divider matching About's gold line style */}
                  ...
                  <li key={i}>
                    ...
                    >
                      <div className="flex items-center gap-2 mb-0.5">
                        <span className="text-gold/25 group-hover:text-gold transition-colors duration-200 text-[10px]">›</span>
                        <span className="font-mono-gh text-[9px] tracking-[2px] text-cream/50 group-hover:text-cream/80 transition-colors duration-200">
                          {label.toUpperCase()}
                        </span>
                      </div>
                      <span className="text-cream/22 text-[11px] font-light pl-4 block leading-snug">
                        {desc}
                      </span>
                    </motion.a>
                  </li>
      ...
      <div className="relative z-10 border-t border-gold/8">
        <div className="px-[clamp(20px,6vw,80px)] py-5 max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
          ...
          <span className="font-mono-gh text-[8px] tracking-[2.5px] text-cream/18">
            © 2025 GOLDENHORDE STUDIO
          </span>

          {/* Centre diamond divider (decorative) */}
          ...
          <span className="font-mono-gh text-[8px] tracking-[2.5px] text-gold/30">
